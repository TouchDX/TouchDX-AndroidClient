...
/* loaded from: K:\FuckMaiRemoteTouch\MaiNative\classes.dex */
public final class PathParser {
    ...
    private static void extract(java.lang.String r8, int r9, com.Yubai.TouchDX.PathParser.ExtractFloatResult r10) {
        int currentIndex = r9;
        ...
        for (; currentIndex < r8.length(); currentIndex++) {
            boolean isPrevExponential = isExponential;
            isExponential = false;
            char currentChar = r8.charAt(currentIndex);
            switch (currentChar) {
                case ' ':
                case ',':
                    foundSeparator = true;
                    break;
                case '-':
                    if (currentIndex != r9 && !isPrevExponential) {
                        foundSeparator = true;
